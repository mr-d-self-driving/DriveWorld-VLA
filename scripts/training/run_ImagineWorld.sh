...
#rm -rf rm /root/.cache/huggingface/modules/transformers_modules/ReCogDrive-VLM-2B && \ 24
...
agent.config._target_=navsim.agents.ImagineWorld.configs.${CONFIG_NAME}.ImagineWorldConfig \
