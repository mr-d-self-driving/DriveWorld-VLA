...
@dataclass
class ImagineWorldConfigStage3:

    trajectory_sampling: TrajectorySampling = TrajectorySampling(
        time_horizon=4, interval_length=0.5
    )

    resnet34_path = '/e2e-data/evad-tech-vla/liulin/WoTE/ckpt/resnet34.pth'
    vlm_path = '/e2e-data/evad-tech-vla/liulin/WoTE/ckpt/ReCogDrive-VLM-2B'
    vlm_type = 'internvl'
    image_architecture: str = "resnet34"
    lidar_architecture: str = "resnet34"
    checkpoint_path = '/e2e-data/evad-tech-vla/liulin/WoTE/ckpt/epoch=19_stage3.ckpt' #'/e2e-data/evad-tech-vla/liulin/WoTE/ckpt/freeze_stage2.ckpt'
    ...
    scorer_config: PDMScorerConfig = field(default_factory=lambda: PDMScorerConfig(
        ...
        driving_direction_violation_threshold=6.0,stopped_speed_threshold=5e-03,
        progress_distance_threshold=5.0
    ))

    metric_cache_path = '/e2e-data/evad-tech-vla/liulin/recogdrive/exp/metric_cache_train_1'
    test_metric_cache_path = '/e2e-data/evad-tech-vla/liulin/WoTE/exp/metric_cache'
    ...
    dit_img_resolution=8
    dit_in_channels=256
    dit_label_dropout=0.2
    dit_num_classes=10
    dit_type='DiT-L/2'
    ...
    sim_reward_dict_path: str = f'/e2e-data/evad-tech-vla/liulin/WoTE/extra_data/planning_vb/formatted_pdm_score_256.npy'
    cluster_file_path = f'/e2e-data/evad-tech-vla/liulin/WoTE/extra_data/planning_vb/trajectory_anchors_256.npy'
