...
@dataclass
class ImagineWorldConfigStage5:
    ...
    #checkpoint_path = '/e2e-data/evad-tech-vla/liulin/WoTE/ckpt/best.ckpt'
    ...
    metric_cache_path = '/e2e-data/evad-tech-vla/liulin/WoTE/exp/metric_cache'
