...
def build_datasets(cfg: DictConfig, agent: AbstractAgent) -> Tuple[Dataset, Dataset]:
    ...
    if train_scene_filter.log_names is not None:
        ...
        train_scene_filter.log_names = list(set(train_scene_filter.log_names) & set(cfg.train_logs)) # liulin add
    else:
    ...
    use_fut_frames = agent.config.use_fut_frames if hasattr(agent.config, "use_fut_frames") else True
    train_data = Dataset(
